...
export class UpdateAccountDetailsComponent {
  ...
  onSubmit(): void {
    if(this.userDetails.clientName && this.userDetails.clientSurname && this.userDetails.clientPhysicalAddress && this.userDetails.clientTitle && this.userDetails.clientPhoneNum){
