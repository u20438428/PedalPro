...
@Component({
  selector: 'app-view-help-company',
  templateUrl: './view-help-company.component.html',
  styleUrls: ['./view-help-company.component.css']
})
export class ViewHelpCompanyComponent implements OnInit{
